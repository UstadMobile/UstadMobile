...
# (str) Package name
package.name = djangolrs

# (str) Package domain (needed for android/ios packaging)
package.domain = org.test.djangolrs

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,html,sqlite3,version
...
android.ndk_path = /home/varuna/UstadMobile/android-ndk-r9c/

# (str) Android SDK directory (if empty, it will be automatically downloaded.)
android.sdk_path = /home/varuna/UstadMobile/android-sdk-linux/

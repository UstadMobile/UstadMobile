...
public class Role {
    ...
    public static final long PERMISSION_SALE_INSERT = 8388608;

    public static final long PERMISSION_SALE_UPDATE = 16777216;

    public static final long PERMISSION_SALE_SELECT = 33554432;

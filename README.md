...
Note: most of our development is currently happening in the soon to be released [dev-mvvm-primary branch](https://github.com/UstadMobile/UstadMobile/tree/dev-mvvm-primary).

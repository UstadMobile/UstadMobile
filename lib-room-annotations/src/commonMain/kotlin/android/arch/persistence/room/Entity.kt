...
/*
 * Retention on the original is actually BINARY.
 */
...
annotation class Entity(
         ...
         *
         * Kotlin translation note: this used to be an empty list constant [] by default, but that
         * is not supported on javascript
         *

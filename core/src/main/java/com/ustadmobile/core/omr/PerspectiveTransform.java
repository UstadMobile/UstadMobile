 ...
 $endif$ */    
    ...
    $endif$ */
	     ...
	     if (Math.abs(tx.m22) <  PERSPECTIVE_DIVIDE_EPSILON) {
  	       throw new IllegalStateException("JaiI18N.getString:NoninvertibleTransformException: PerspectiveTransform0");
	     }
	     tx.normalize();
	     return tx;
    }
        ...
        while (numPts-- > 0) {
            ...
            if (wabs < PERSPECTIVE_DIVIDE_EPSILON) {
                throw new IllegalStateException(
				    "JaiI18N.getString:NoninvertibleTransformException: PerspectiveTransform1");
            }

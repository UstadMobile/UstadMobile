...
interface BasePointView : UstadView {
     ...
     * @param visible
     */
    fun setClassListVisible(visible: Boolean)
     ...
     * @param menuItems
     */
    fun setMenuItems(menuItems: Array<BasePointMenuItem>)
    ...
    fun setShareAppDialogProgressVisible(visible: Boolean)

    fun dismissShareAppDialog()

    fun addTab(tabArguments: Map<String, String>)

...
import com.ustadmobile.core.view.VideoPlayerView.ARG_CONTAINER_UID
import com.ustadmobile.core.view.VideoPlayerView.ARG_CONTENT_ENTRY_ID
    ...
    override fun onCreate(savedState: Map<String, String> ?) {
        ...
        containerEntryDao.findByContainer(containerUid, object : UmCallback<List<ContainerEntryWithContainerEntryFile>> {
            override fun onSuccess(result: List<ContainerEntryWithContainerEntryFile>) {
                ...
                view.runOnUiThread { view.setVideoParams(videoPath, audioPath, srtPath) }
            }

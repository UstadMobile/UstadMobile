...
class ScopedGrantEditPresenter(
    ...
    companion object {
        ...
        val PERMISSION_MESSAGE_ID_LIST = listOf(
            BitmaskMessageId(Role.PERMISSION_PERSON_DELEGATE, MR.strings.view_school),
            BitmaskMessageId(Role.PERMISSION_SCHOOL_SELECT, MR.strings.view_school),
            BitmaskMessageId(Role.PERMISSION_SCHOOL_UPDATE, MR.strings.edit_school),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_ADD_STUDENT, MR.strings.enrol_and_unenrol_students),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_ADD_TEACHER, MR.strings.enrol_and_unenrol_teachers),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_SELECT, MR.strings.view_clazzes),
            BitmaskMessageId(Role.PERMISSION_ADD_CLASS_TO_SCHOOL, MR.strings.add_new_clazz_to_school),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_UPDATE, MR.strings.edit_clazzes),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_LOG_ATTENDANCE_INSERT, MR.strings.permission_attendance_insert),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_LOG_ATTENDANCE_SELECT, MR.strings.permission_attendance_select),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_LOG_ATTENDANCE_UPDATE, MR.strings.permission_attendance_update),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_CONTENT_SELECT, MR.strings.view_class_content),
            BitmaskMessageId(Role.PERMISSION_CLAZZ_CONTENT_UPDATE, MR.strings.edit_class_content),
            BitmaskMessageId(Role.PERMISSION_ASSIGNMENT_SELECT, MR.strings.view_assignments),
            BitmaskMessageId(Role.PERMISSION_ASSIGNMENT_UPDATE, MR.strings.add_or_edit_assignment),
            BitmaskMessageId(Role.PERMISSION_PERSON_LEARNINGRECORD_SELECT, MR.strings.view_class_learning_records),
            BitmaskMessageId(Role.PERMISSION_PERSON_SELECT, MR.strings.view_basic_profile_of_members),
            BitmaskMessageId(Role.PERMISSION_PERSON_UPDATE, MR.strings.edit_basic_profile_of_members),
            BitmaskMessageId(Role.PERMISSION_PERSONCONTACT_SELECT, MR.strings.view_contact_details_of_members),
            BitmaskMessageId(Role.PERMISSION_PERSONCONTACT_UPDATE, MR.strings.edit_contact_details_of_members),
            BitmaskMessageId(Role.PERMISSION_PERSONSOCIOECONOMIC_SELECT, MR.strings.view_socioeconomic_details_of_members),
            BitmaskMessageId(Role.PERMISSION_PERSONSOCIOECONOMIC_UPDATE, MR.strings.edit_socioeconomic_details_of_members))
        ...
        val PERMISSION_LIST_MAP: Map<Int, List<BitmaskMessageId>> = mapOf(
            Clazz.TABLE_ID to listOf(
                BitmaskMessageId(Role.PERMISSION_PERSON_DELEGATE, MR.strings.permission_person_delegate),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_SELECT, MR.strings.view_clazz),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_UPDATE, MR.strings.edit_clazz),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_ADD_STUDENT, MR.strings.enrol_and_unenrol_students),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_ADD_TEACHER, MR.strings.enrol_and_unenrol_teachers),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_LOG_ATTENDANCE_SELECT, MR.strings.permission_attendance_select),
                BitmaskMessageId(Role.PERMISSION_CLAZZ_LOG_ATTENDANCE_UPDATE, MR.strings.permission_attendance_update),

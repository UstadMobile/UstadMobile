    ...
    companion object {
        ...
        val PERMISSION_LIST_MAP: Map<Int, List<BitmaskMessageId>> = mapOf(
            Clazz.TABLE_ID to listOf(
                ...
                BitmaskMessageId(Role.PERMISSION_CLAZZWORK_SELECT, MessageID.view_assignments),
                BitmaskMessageId(Role.PERMISSION_CLAZZWORK_UPDATE, MessageID.add_or_edit_assignment),

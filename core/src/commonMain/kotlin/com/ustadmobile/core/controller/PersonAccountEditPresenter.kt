...
class PersonEditPresenter(context: Any,
    ...
    override fun handleClickSave(entity: Person) {
        ...
        if(workSpace.registrationAllowed && (entity.username == null
            ...
            view.passwordRequiredErrorVisible = view.password == null
            view.confirmPasswordErrorVisible = view.confirmedPassword == null
            view.noMatchPasswordErrorVisible = view.password != view.confirmedPassword
            return
        }

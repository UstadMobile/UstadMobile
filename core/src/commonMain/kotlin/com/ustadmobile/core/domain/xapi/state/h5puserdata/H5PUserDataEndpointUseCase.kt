 ...
 *
 * Unfortunately, the documentation for ContentUserData still shows "coming soon" here
...
class H5PUserDataEndpointUseCase(
    ...
    suspend operator fun invoke(
        ...
        return if(request.method == IHttpRequest.Companion.Method.POST) {
            ...
            //IContentUserData definition:
            //https://github.com/Lumieducation/H5P-Nodejs-library/blob/master/packages/h5p-server/src/types.ts#L584

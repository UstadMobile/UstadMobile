...
//
//
//class AuditLogListPresenterTest : AbstractSetup() {
//
...
//            : Pair<AuditLogListView, AuditLogListPresenter> {
//        val mockView = mock<AuditLogListView> {
...
//        val presenter = AuditLogListPresenter(mockContext,
//                presenterArgs, mockView, systemImplSpy)
//        return Pair(mockView, presenter)
//    }
//
//    @Test
//    fun givenPresenterCreated_whenRelevantArgsGiven_shouldupdateListProviderOnView() {
...
//
//    @Test
//    fun givenPresenterCreatedWithArgs_whenDataToCSVCalled_shouldUpdateGenerateCSVReportWithDataOnView() {
//        // create presenter, with a mock view, check that it makes that call
//        val (view, presenter) = createMockViewAndPresenter()
//        presenter.onCreate(mapOf())
//

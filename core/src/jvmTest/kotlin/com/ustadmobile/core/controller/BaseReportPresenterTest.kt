...
//
//
//class BaseReportPresenterTest : AbstractSetup() {
//
...
//            : Pair<BaseReportView, BaseReportPresenter> {
//        val mockView = mock<BaseReportView> {
...
//        val presenter = BaseReportPresenter(mockContext,
//                presenterArgs, mockView, systemImplSpy)
//        return Pair(mockView, presenter)
//    }
//
//    @Test
//    fun givenPresenterCreated_whenGoToReportCalled_ShouldGoToReportEdit() {

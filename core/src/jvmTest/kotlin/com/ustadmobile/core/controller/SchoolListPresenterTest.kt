...
class SchoolListPresenterTest : AbstractSetup() {
    ...
    fun createMockViewAndPresenter(presenterArgs: Map<String, String> = mapOf())
            : Pair<SchoolListView, SchoolListPresenter> {
        val mockView = mock<SchoolListView> {
        ...
        val presenter = SchoolListPresenter(mockContext,

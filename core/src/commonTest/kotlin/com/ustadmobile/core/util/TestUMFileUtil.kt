...
//
//    @Test
//    fun testSplitCombinedViewArguments() {
//        val combinedArgs = HashMap<String, String>()
//        val catalogUrl0 = "http://www.ustadmobile.com/files/s4s/index.testnewcat.opds"
//        combinedArgs["catalog-0-url"] = catalogUrl0

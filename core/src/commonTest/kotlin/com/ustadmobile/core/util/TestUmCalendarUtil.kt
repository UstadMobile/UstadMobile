...
class TestUmCalendarUtil {

    @Test
    fun testHttpDateParsing() {
        val date1 = UMCalendarUtil.parseHTTPDate("Sun, 06 Nov 1994 08:49:37 GMT")
        val date2 = UMCalendarUtil.parseHTTPDate("Sunday, 06-Nov-94 08:49:37 GMT")
        val date3 = UMCalendarUtil.parseHTTPDate("Sun Nov  6 08:49:37 1994 ")

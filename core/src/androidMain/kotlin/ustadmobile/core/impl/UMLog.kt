...
actual class UMLog {
    ...
    actual companion object {
         ...
         */
        actual fun l(level: Int, code: Int, message: String?) {
        }
         ...
         * @param exception
         */
        actual fun l(level: Int, code: Int, message: String, exception: Exception) {
        }

        actual val CRITICAL: Int

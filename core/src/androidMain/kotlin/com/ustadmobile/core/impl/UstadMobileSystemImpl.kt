...
actual open class UstadMobileSystemImpl : UstadMobileSystemCommon() {
    ...
    private val viewNameToAndroidImplMap = mapOf<String, String>(
            ...
            UserProfileView.VIEW_NAME to "${PACKAGE_NAME}UserProfileActivity",
            ...
            ClazzDetailView.VIEW_NAME to "${STAGING_PACKAGE_NAME}ClazzDetailActivity",
            ClassLogDetailView.VIEW_NAME to "${STAGING_PACKAGE_NAME}ClazzLogDetailActivity",
            PersonDetailView.VIEW_NAME to "${STAGING_PACKAGE_NAME}PersonDetailActivity",
            PersonEditView.VIEW_NAME to "${STAGING_PACKAGE_NAME}PersonEditActivity",
            PersonDetailEnrollClazzView.VIEW_NAME to "${STAGING_PACKAGE_NAME}PersonDetailEnrollClazzActivity",
            ClazzDetailEnrollStudentView.VIEW_NAME to "${STAGING_PACKAGE_NAME}ClazzDetailEnrollStudentActivity",
            ...
            SelectPeopleDialogView.VIEW_NAME to "${STAGING_PACKAGE_NAME}SelectPeopleDialogFragment",

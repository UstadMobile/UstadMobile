...
class DiscussionPostDetail2Fragment: UstadBaseFragment(), DiscussionPostDetailView,
...
private fun Messages(
    replies: List<MessageWithPerson> = emptyList(),
    onClickMessage: (MessageWithPerson) -> Unit = {}
){
...
@Composable
private fun MessageItem(post: MessageWithPerson){
    Row(
        modifier = Modifier
            .padding(8.dp)
            .fillMaxWidth(),
        ...
        val datePosted = remember { DateFormat.getDateFormat(context)
            .format(Date(post.messageTimestamp ?: 0)).toString() }

        val fullName= post.messagePerson?.fullName() ?: ""
        UstadMessageField(
            imageId = R.drawable.ic_person_black_24dp,
            mainText = fullName,
            secondText = post.messageText ?: "",
            thirdText = "",
...
@Composable
private fun DiscussionPostDetailScreen(
    uiState: DiscussionPostDetailUiState = DiscussionPostDetailUiState(),
    onClickDeleteMessage: (MessageWithPerson) -> Unit = {},
    onClickMessage: (MessageWithPerson) -> Unit = {},
    onClickAddMessage: (MessageWithPerson) -> Unit = {},
) {
    ...
    Column(
        ...
        UstadMessageField(
            imageId = R.drawable.ic_person_black_24dp,
            mainText = fullName,
            secondText = uiState.discussionPost?.discussionPostMessage ?: "",
            thirdText = "",
            fourthText = datePosted,
            fifthText = "",
            thirdTextIcon = 0
...
//        Spacer(modifier = Modifier.height(10.dp))
//        Text(
//            uiState.discussionPost?.discussionPostMessage ?: "",
//            style = Typography.body1,
//            modifier = Modifier.padding(8.dp)
//        )
        Spacer(modifier = Modifier.height(10.dp))
    ...
    val uiState = DiscussionPostDetailUiState(
        ...
        replies = listOf(
            ...
            MessageWithPerson().apply {
                ...
                messageText = "I think it is briefly explained in secton 42"
            },

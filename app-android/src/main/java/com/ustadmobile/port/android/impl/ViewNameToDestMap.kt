...
class ViewNameToDestMap: DestinationProvider {
    ...
    private val destinationMap = mapOf(
            ...
            ProductEditView.VIEW_NAME to UstadDestination(R.id.product_edit_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true),
            ProductListView.VIEW_NAME to UstadDestination(R.id.home_product_dest),
            ...
            SaleDeliveryEditView.VIEW_NAME to UstadDestination(R.id.saledelivery_edit_dest, hideAccountIcon = true)
    )

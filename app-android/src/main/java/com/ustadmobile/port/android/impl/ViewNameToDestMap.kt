...
class ViewNameToDestMap: DestinationProvider {
    ...
    private val destinationMap = mapOf(
            ClazzEditViewModel.DEST_NAME to UstadDestination(R.id.clazz_edit_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                    hideBottomNavigation = true),
            ClazzListViewModel.DEST_NAME_HOME to UstadDestination(R.id.home_clazzlist_dest),
            ClazzListViewModel.DEST_NAME to UstadDestination(R.id.clazz_list_dest),
            ...
            HolidayEditView.VIEW_NAME to UstadDestination(R.id.holiday_edit_dest,
                    hideBottomNavigation = true),
            HolidayCalendarListViewModel.DEST_NAME to UstadDestination(R.id.holidaycalendar_list_dest),
            SettingsView.VIEW_NAME to UstadDestination(R.id.settings_list_dest),
            PersonEditViewModel.DEST_NAME to UstadDestination(R.id.person_edit_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                    hideBottomNavigation = true),
            ...
            PersonListViewModel.DEST_NAME to UstadDestination(R.id.person_list_dest),
            PersonListViewModel.DEST_NAME_HOME to UstadDestination(R.id.home_personlist_dest),
            ClazzAssignmentEditViewModel.DEST_NAME to UstadDestination(R.id.clazz_assignment_edit_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                    hideBottomNavigation = true),
            ...
            DiscussionPostDetailViewModel.DEST_NAME to UstadDestination(R.id.discussion_post_detail_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true),
            CourseTerminologyListViewModel.DEST_NAME to UstadDestination(R.id.course_terminology_list_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true),
            CourseTerminologyEditViewModel.DEST_NAME to UstadDestination(R.id.course_terminology_edit_dest,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                    hideBottomNavigation = true),
            ...
            CourseGroupSetDetailViewModel.DEST_NAME to UstadDestination(R.id.course_group_set_detail,
                    actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true),
            ClazzAssignmentDetailViewModel.DEST_NAME to UstadDestination(R.id.clazz_assignment_detail_dest),
            ...
            StatementListViewModel.DEST_NAME to UstadDestination(R.id.content_entry_detail_session_detail_list_dest),
            ...
            LanguageListViewModel.DEST_NAME to UstadDestination(R.id.language_list_dest),
            ...
            SiteDetailViewModel.DEST_NAME to UstadDestination(R.id.site_detail_dest),
            SiteEditViewModel.DEST_NAME to UstadDestination(R.id.site_edit_dest,
                actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                    hideBottomNavigation = true),
            ...
            SiteTermsDetailView.VIEW_NAME_ACCEPT_TERMS to UstadDestination(R.id.site_terms_detail_accept_dest,
                actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideBottomNavigation = true,
                hideAccountIcon = true),
            ScheduleEditViewModel.DEST_NAME to UstadDestination(R.id.schedule_edit_dest,
                actionBarScrollBehavior = SCROLL_FLAG_NO_SCROLL, hideAccountIcon = true,
                hideBottomNavigation = true),
            ...
            RegisterAgeRedirectView.VIEW_NAME to UstadDestination(R.id.register_age_redirect_dest,
                hideBottomNavigation = true, hideAccountIcon = true),
            ParentalConsentManagementViewModel.DEST_NAME to UstadDestination(R.id.parental_consent_management_dest),
            ScopedGrantEditViewModel.DEST_NAME to UstadDestination(R.id.scoped_grant_edit_dest,

...
class ContentEntryDetailLanguageAdapter(private val data: List<ContentEntryRelatedEntryJoinWithLanguage>, val listener: ContentEntry2DetailFragment) : RecyclerView.Adapter<ContentEntryDetailLanguageAdapter.LangHolder>() {

...
class CustomFieldListRecyclerAdapter(
        diffCallback: DiffUtil.ItemCallback<CustomField>,
        internal var mPresenter: CustomFieldListPresenter, internal var theActivity: Activity,
        internal var theContext: Context)
    : PagedListAdapter<CustomField, CustomFieldListRecyclerAdapter.CustomFieldListViewHolder>(diffCallback) {

...
class ContentEntryDetailLanguageAdapter(private val data: List<ContentEntryRelatedEntryJoinWithLanguage>, val listener: AdapterViewListener) : RecyclerView.Adapter<ContentEntryDetailLanguageAdapter.LangHolder>() {

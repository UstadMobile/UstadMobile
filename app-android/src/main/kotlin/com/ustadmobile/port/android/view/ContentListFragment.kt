...
class ContentListFragment : UstadBaseFragment, ContentListView,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        rootContainer = inflater.inflate(R.layout.fragment_content_list, container, false)
        ...
        val viewPager = rootContainer.findViewById<ViewPager>(
                R.id.fragment_content_list_library_viewpager)
        viewPager.adapter = LibraryPagerAdapter(fragmentManager!!, context!!)
    ...
    class LibraryPagerAdapter internal constructor(fragmentManager: FragmentManager, private val context: Context) : FragmentPagerAdapter(fragmentManager) {
        ...
        override fun getItem(position: Int): Fragment? {
            ...
            return when (position) {
                ...
                -> {
                    bundle.putString(ContentEntryListFragmentPresenter.ARG_CONTENT_ENTRY_UID, HomePresenter.MASTER_SERVER_ROOT_ENTRY_UID.toString())

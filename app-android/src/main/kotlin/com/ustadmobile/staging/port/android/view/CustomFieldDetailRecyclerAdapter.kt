...
class CustomFieldDetailRecyclerAdapter(
        diffCallback: DiffUtil.ItemCallback<CustomFieldValueOption>,
        internal var mPresenter: CustomFieldDetailPresenter, internal var theActivity: Activity,
        internal var theContext: Context)
    : PagedListAdapter<CustomFieldValueOption,
        CustomFieldDetailRecyclerAdapter.CustomFieldDetailViewHolder>(diffCallback) {

...
import com.ustadmobile.port.android.view.SaleListFragment
import org.hamcrest.Matcher

object SaleListScreen : KScreen<SaleListScreen>() {


    override val layoutId: Int?
        get() = R.layout.fragment_list
    override val viewClass: Class<*>?
        get() = SaleListFragment::class.java
    ...
    class Sale(parent: Matcher<View>) : KRecyclerItem<Sale>(parent) {

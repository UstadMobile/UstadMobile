...
class ContentJobItemTriggerCallbackInstrumentationTest {
    ...
    fun givenJobHasSubFoldersAndOneJobItemFailed_whenRecursiveStatusUpdated_thenParentOfSubFolderShouldBePartialFailed(){
        ...
        runBlocking {
            ...
            Assert.assertEquals("sub folder partial failed", JobStatus.PARTIAL_FAILED, childFolderItem!!.cjiRecursiveStatus)

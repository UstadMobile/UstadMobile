...
object CategoryListScreen : KScreen<CategoryListScreen>() {


    override val layoutId: Int?
        get() = R.layout.fragment_list
    override val viewClass: Class<*>?
        get() = CategoryListFragment::class.java
    ...
    class Category(parent: Matcher<View>) : KRecyclerItem<Category>(parent) {

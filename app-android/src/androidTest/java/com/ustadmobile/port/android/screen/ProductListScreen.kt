...
import com.ustadmobile.port.android.view.ProductListFragment
import org.hamcrest.Matcher

object ProductListScreen : KScreen<ProductListScreen>() {


    override val layoutId: Int?
        get() = R.layout.fragment_list
    override val viewClass: Class<*>?
        get() = ProductListFragment::class.java
    ...
    class Product(parent: Matcher<View>) : KRecyclerItem<Product>(parent) {

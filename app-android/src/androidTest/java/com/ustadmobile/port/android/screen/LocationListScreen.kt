...
object LocationListScreen : KScreen<LocationListScreen>() {


    override val layoutId: Int?
        get() = R.layout.fragment_list
    override val viewClass: Class<*>?
        get() = LocationListFragment::class.java
    ...
    class Location(parent: Matcher<View>) : KRecyclerItem<Location>(parent) {

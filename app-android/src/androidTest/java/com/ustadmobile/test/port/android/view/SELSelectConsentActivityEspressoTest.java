...
public class SELSelectConsentActivityEspressoTest {
     ...
     */
    @Rule
    public IntentsTestRule<SELSelectConsentActivity> mActivityRule =
            new IntentsTestRule<>(SELSelectConsentActivity.class, false, false);

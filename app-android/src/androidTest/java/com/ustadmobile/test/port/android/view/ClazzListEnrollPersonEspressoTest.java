...
import com.ustadmobile.port.android.view.ClazzListEnrollPersonActivity;
...
public class ClazzListEnrollPersonEspressoTest {
     ...
     */
    @Rule
    public IntentsTestRule<ClazzListEnrollPersonActivity> mActivityRule =
            new IntentsTestRule<>(ClazzListEnrollPersonActivity.class, false, false);

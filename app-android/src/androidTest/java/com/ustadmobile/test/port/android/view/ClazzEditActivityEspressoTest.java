...
public class ClazzEditActivityEspressoTest {
     ...
     */
    @Rule
    public IntentsTestRule<ClazzEditActivity> mActivityRule =
            new IntentsTestRule<>(ClazzEditActivity.class, false, false);

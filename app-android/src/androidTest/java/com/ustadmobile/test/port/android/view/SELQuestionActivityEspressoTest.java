...
public class SELQuestionActivityEspressoTest {
     ...
     */
    @Rule
    public IntentsTestRule<SELQuestionActivity> mActivityRule =
            new IntentsTestRule<>(SELQuestionActivity.class, false, false);

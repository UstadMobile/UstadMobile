...
public class SELSelectStudentActivityEspressoTest {
     ...
     */
    @Rule
    public IntentsTestRule<SELSelectStudentActivity> mActivityRule =
            new IntentsTestRule<>(SELSelectStudentActivity.class, false, false);

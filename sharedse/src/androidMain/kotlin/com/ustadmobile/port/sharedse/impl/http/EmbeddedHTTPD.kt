 ...
 */
open class EmbeddedHTTPD @JvmOverloads constructor(portNum: Int, context: Any, private val appDatabase: UmAppDatabase = UmAppDatabase.getInstance(context), private val repository: UmAppDatabase = appDatabase.getRepository("http://localhost/dummy/", "")) : RouterNanoHTTPD(portNum) {

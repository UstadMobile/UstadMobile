...
expect interface FetchListenerMpp {
     ...
     * */
    fun onAdded(download: DownloadMpp)
     ...
     * */
    fun onQueued(download: DownloadMpp, waitingOnNetwork: Boolean)
     ...
     * */
    fun onError(download: DownloadMpp, error: Error, throwable: Throwable?)
     ...
     * */
    fun onDownloadBlockUpdated(download: DownloadMpp, downloadBlock: DownloadBlockMpp, totalBlocks: Int)
     ...
     * about a specific download managed by Fetch.
     * */
    fun onStarted(download: DownloadMpp, downloadBlocks: List<DownloadBlockMpp>, totalBlocks: Int)
     ...
     * */
    fun onProgress(download: DownloadMpp, etaInMilliSeconds: Long, downloadedBytesPerSecond: Long)

    /** Called when a download is paused. The status of the download will be Status.PAUSED.
     * @param download An immutable object which contains a current snapshot of all the information
     * about a specific download managed by Fetch.
     * */
    fun onPaused(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    fun onResumed(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    fun onCancelled(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    fun onRemoved(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    fun onDeleted(download: DownloadMpp)

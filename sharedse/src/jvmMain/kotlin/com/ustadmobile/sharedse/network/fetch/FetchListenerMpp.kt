...
actual interface FetchListenerMpp {
     ...
     * */
    actual fun onAdded(download: DownloadMpp)
     ...
     * */
    actual fun onQueued(download: DownloadMpp, waitingOnNetwork: Boolean)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onWaitingNetwork(download: DownloadMpp)

    /** Called when a download completes. The status of the download will be Status.COMPLETED.
     * @param download An immutable object which contains a current snapshot of all the information
     * about a specific download managed by Fetch.
     * */
    actual fun onCompleted(download: DownloadMpp)
     ...
     * */
    actual fun onError(download: DownloadMpp, error: Error, throwable: Throwable?)
     ...
     * */
    actual fun onDownloadBlockUpdated(download: DownloadMpp, downloadBlock: DownloadBlockMpp, totalBlocks: Int)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onStarted(download: DownloadMpp, downloadBlocks: List<DownloadBlockMpp>, totalBlocks: Int)
     ...
     * */
    actual fun onProgress(download: DownloadMpp, etaInMilliSeconds: Long, downloadedBytesPerSecond: Long)

    /** Called when a download is paused. The status of the download will be Status.PAUSED.
     * @param download An immutable object which contains a current snapshot of all the information
     * about a specific download managed by Fetch.
     * */
    actual fun onPaused(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onResumed(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onCancelled(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onRemoved(download: DownloadMpp)
     ...
     * about a specific download managed by Fetch.
     * */
    actual fun onDeleted(download: DownloadMpp)

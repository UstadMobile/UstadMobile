...
abstract class BleEntryStatusTask : Runnable, BleMessageResponseListener {
     ...
     */
    constructor(context: Any, managerBle: NetworkManagerBle, entryUidsToCheck: List<Long>,
     ...
     */
    constructor(context: Any, managerBle: NetworkManagerBle, message: BleMessage, peerToSendMessageTo: NetworkNode,
     ...
     */
    internal fun setManagerBle(managerBle: NetworkManagerBle) {
        this.managerBle = managerBle
    }

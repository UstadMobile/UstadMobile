...
public abstract class ClazzMemberDao implements SyncableDao<ClazzMember, ClazzMemberDao> {
    ...
    public static final String AT_RISK_STUDENT_REPORT_QUERY =
            "SELECT " +
                    "   Person.* , " +
                    "" +
    ...
    @UmQuery(AT_RISK_STUDENT_REPORT_QUERY)
    public abstract UmProvider<PersonWithEnrollment> findAllStudentsAtRiskForClazzListAsync(List<Long> clazzes,
                                                                                            float riskThreshold);

    @UmQuery(AT_RISK_STUDENT_REPORT_QUERY)
    public abstract void findAllStudentsAtRiskForClazzListAsync(List<Long> clazzes,
                            float riskThreshold, UmCallback<List<PersonWithEnrollment>> resultCallback);

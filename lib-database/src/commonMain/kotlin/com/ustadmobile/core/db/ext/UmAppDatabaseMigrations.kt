...
val MIGRATION_208_209 = DoorMigrationStatementList(208, 209) { db ->
    ...
    buildList {
        if (db.dbType() == DoorDbType.SQLITE) {
            add("ALTER TABLE Site ADD COLUMN bottomNavVisibilityFlag INTEGER NOT NULL DEFAULT $BOTTOM_NAV_DEFAULT_FLAG")
        } else {
            add("ALTER TABLE Site ADD COLUMN bottomNavVisibilityFlag BIGINT NOT NULL DEFAULT $BOTTOM_NAV_DEFAULT_FLAG")
        }
    }
}

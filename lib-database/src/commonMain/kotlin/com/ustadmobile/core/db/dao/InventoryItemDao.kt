...
abstract class InventoryItemDao : BaseDao<InventoryItem> {
    ...
    @Query(QUERY_GET_STOCK_LIST_BY_PRODUCT_AND_DELIVERY2)
    ...
    companion object{
        ...
        const val QUERY_GET_STOCK_LIST_BY_PRODUCT_AND_DELIVERY = """
            ...
            WHERE
                ...
                (Person.personUid IN (
                    ...
                    AND MEMBER.personGoldoziType = ${Person.GOLDOZI_TYPE_PRODUCER}) 
        ...
        const val QUERY_GET_STOCK_LIST_BY_PRODUCT_AND_DELIVERY2 = """
            SELECT 
                MEMBER.*,
                InventoryItem.*, 
                (

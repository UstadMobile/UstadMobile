...
abstract class UmAppDatabase : DoorDatabase(), SyncableDoorDatabase {
    ...
    /*
        ...
        Delete PersonCustomField
        Add ClazzLog, ClazzLogAttendanceRecord, FeedEntry, PersonField,
        PersonDetailPresenterField,SelQuestion,
        SelQuestionResponse, SelQuestionResponseNomination, SelQuestionSet,
        SelQuestionSetRecognition, SelQuestionSetResponse,
        Schedule, DateRange, UMCalendar,
        ClazzActivity, ClazzActivityChange,
        SelQuestionOption, ScheduledCheck,
        AuditLog, CustomField, CustomFieldValue, CustomFieldValueOption,
    ...
    companion object {
        ...
        val MIGRATION_32_34 = object : DoorMigration(32, 34){
            override fun migrate(database: DoorSqlDatabase) {
                if(database.dbType() == DoorDbType.SQLITE){
...
//Begin: Create table School for PostgreSQL
        ...
        private fun addMigrations(builder: DatabaseBuilder<UmAppDatabase>): DatabaseBuilder<UmAppDatabase> {
            ...
            builder.addMigrations(MIGRATION_27_28, MIGRATION_29_30_TRIGGERS, MIGRATION_29_30,
                    MIGRATION_30_31, MIGRATION_31_32, MIGRATION_32_34)

...
fun <T: UstadViewModel> useUstadViewModel(
    ...
    val contextDi = useRequiredContext(DIContext)
    val ustadScreensContext = useContext(UstadScreensContext)
        ?: throw IllegalStateException("useUstadViewModel: No UstadScreensContext!")

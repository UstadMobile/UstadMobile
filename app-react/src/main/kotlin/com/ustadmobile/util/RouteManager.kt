...
object RouteManager {
    ...
    val destinationList = listOf(
        ...
        UmReactDestination("pie_chart", MessageID.reports, ReportListView.VIEW_NAME, PlaceHolderComponent::class, divider = true),
        UmReactDestination("settings", MessageID.settings, SettingsView.VIEW_NAME, PlaceHolderComponent::class),
        UmReactDestination(view = Login2View.VIEW_NAME, labelId = MessageID.login, component = LoginComponent::class, showNavigation = false),
        UmReactDestination( labelId= MessageID.accounts, view = AccountListView.VIEW_NAME, component = PlaceHolderComponent::class),
        UmReactDestination(view = ContentEntryDetailView.VIEW_NAME, component = ContentEntryDetailComponent::class),
        UmReactDestination(view = XapiPackageContentView.VIEW_NAME, component = XapiPackageContentComponent::class),
        UmReactDestination(view = EpubContentView.VIEW_NAME, component = EpubContentComponent::class),
        UmReactDestination(view = ContentEntryList2View.VIEW_NAME, component = ContentEntryListComponent::class),
        UmReactDestination(view = VideoContentView.VIEW_NAME, component = VideoContentComponent::class),

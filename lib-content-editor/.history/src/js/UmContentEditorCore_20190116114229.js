...
UmContentEditorCore.insertMediaContent = (source, mimeType) => {
    ...
    if(mimeType.includes("image")){
        mediaContent = '<div align="center" class="embed-responsive embed-responsive-16by9">''<img src="'+source+'" class="embed-responsive-item">';
    ...
    mediaContent = +mediaContent + '</div><p><br/></p>';

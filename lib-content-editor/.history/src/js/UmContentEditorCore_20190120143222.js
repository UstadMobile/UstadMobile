 ...
 * other protected element from being delete from th editor, where to focus next when event happens on protected
 * elements and handles editor state like Initializing it and formatting the content inside it).
 * 

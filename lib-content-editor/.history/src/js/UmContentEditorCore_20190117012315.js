...
UmContentEditorCore.prototype.saveEditorState = () => {
    ...
    console.log("roll-active",currentActiveElementTracker)
};
            ...
            const contentChangeObserver = new MutationObserver(function(mutations) {
                ...
                if(UmContentEditorCore.prototype.rollbackChangesAfterMutation(mutations)){
                    ...
                    setTimeout(() => {
                        ...
                        const classSelector = $(currentActiveElementTracker[0]).attr("class").split(/\s+/)[0];
                        const focus = editorContainer.find("+classSelector);
                        UmContentEditorCore.prototype.setCursorToAnyNonProtectedFucusableElement(focus.get(0))
                        console.log("roll-active",classSelector)
                    }, longerEventTimeout);
                }else{
                    UmContentEditorCore.prototype.saveEditorState();
                }

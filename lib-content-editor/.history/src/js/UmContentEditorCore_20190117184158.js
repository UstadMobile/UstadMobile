...
UmContentEditorCore.checkProtectedElements = (currentNode,isDeleteKey,selectedContentLength, event) => {
    const preventEvent = UmContentEditorCore.prototype.isElementProtected(currentNode,selectedContentLength,isDeleteKey,false);
    if(){
...
UmContentEditorCore.prototype.isElementProtected = (currentNode = null,selectedContentLength = null, isDeleteKey, isCallback = true) =>{
    if(currentNode === null){

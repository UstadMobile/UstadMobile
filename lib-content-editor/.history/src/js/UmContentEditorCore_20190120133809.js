...
UmContentEditorCore.checkProtectedElements = (currentNode,isDeleteKey,selectedContentLength, event) => {
    if(UmContentEditorCore.prototype.isElementProtected(currentNode,selectedContentLength,isDeleteKey,false)){
        eventOcurredAfterSelectionProtectionCheck = selectedContentLength.length > 0;
 ...
 * */
UmContentEditorCore.prototype.isElementProtected = (currentNode,selectedContentLength, isDeleteKey = false, isCallback = true)=>{
    ...
    console.log("umEditor",(selectedContentLength > 0 && $(currentNode).find(doNotRemoveSelector).length > 0));
...
UmContentEditorCore.prototype.onProtectedElementCheck = () => {
    const isProtected = UmContentEditorCore.prototype.isElementProtected();
    try{
        ...
        init_instance_callback: (ed) => {
            ...
            ed.on('SelectionChange', (e) => {
                ...
                try{
                    ...
                    const protectedElementSelected = $(selectedContent).is(doNotRemoveSelector);
                    console.log("umEditor",protectedElementSelected);

...
UmQuestionWidget.prototype.startEditing = function() {
    ...
    $(this.element).find(".question-retry-btn").html("<button class='float-right qn-retry extra-b' data-um-preview='support'>"+UmQuestionWidget._locale.placeholders.labelForTryAgainOptionBtn+"</button>");

...
UmQuestionWidget.prototype.handleQuestionChoice = (element) => {
    $(element).find(".question-add-choice").removeClass("hide-element").addClass("show-element")
        .html("<button class='btn btn-primary float-right add-choice default-margin-top extra-btn'>" +UmQuestionWidget._locale.placeholders.labelForAddChoiceBtn+"</button>");

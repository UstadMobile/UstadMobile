 ...
 */
UmContentEditorCore.setFocusToNextUnprotectedFocusableElement = (eventTargetElement = null) => {
    ...
    let eventTargetElement = event == null ? tinymce.activeEditor.getNode() :event.target;
    if(event){

...
let elementToFocusAfterRollbackAction = null;
...
UmContentEditorCore.prototype.saveEditorState = () => {
    ...
    elementToFocusAfterRollbackAction = currentActiveElementTracker[0];
};
            ...
            const contentChangeObserver = new MutationObserver(function(mutations) {
                ...
                if(UmContentEditorCore.prototype.rollbackChangesAfterMutation(mutations)){
                    ...
                    setTimeout(() => {
                        ...
                        const classSelector = $(elementToFocusAfterRollbackAction.ele).attr("class").split(/\s+/)[0];

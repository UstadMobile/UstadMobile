...
UmQuestionWidget.prototype.handleExistingQuestionNode = (element) => {
    ...
    $(element).find("").addClass("show-element").removeClass("hide-element");
    $(element).find(".question-choice-answer , .question-choice-feedback, .fill-blanks,.select-option , .question-action-holder")
 ...
 * @returns question widget with controls
 */
UmOtherContentWidget.prototype.startEditing = () =>{
    UmQuestionWidget.prototype.startEditing.apply(this, arguments);

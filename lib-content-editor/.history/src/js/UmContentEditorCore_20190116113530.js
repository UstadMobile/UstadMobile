...
UmContentEditorCore.insertMediaContent = (source, mimeType) => {
    ...
    if(mimeType.includes("image")){
        mediaContent = '<img src="'+source+'" class="embed-responsive-item">';
    }else if(mimeType.includes("audio")){
        mediaContent = '<audio controls controlsList="nodownload"><source src="'+source+'" type="'+mimeType+'"></audio>';
    }else{
        mediaContent = '<video controls controlsList="nodownload" class="embed-responsive-item"><source src="'+source+'" type="'+mimeType+'"></video>';
    }
    mediaContent = '<div align="center" class="embed-responsive embed-responsive-16by9">'+mediaContent + '</div><p><br/></p>';
    ...
    const parentChildren = $($(currentElement.parent()).children()).last();

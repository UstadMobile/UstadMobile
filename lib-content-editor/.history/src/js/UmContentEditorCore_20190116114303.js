...
UmContentEditorCore.insertMediaContent = (source, mimeType) => {
    ...
    if(mimeType.includes("image")){
        ...
        '<img src="'+source+'" class="embed-responsive-item">'+'</div>';
    }else if(mimeType.includes("audio")){
        mediaContent = '<audio controls controlsList="nodownload"><source src="'+source+'" type="'+mimeType+'"></audio>';
    }else{
        mediaContent = '<div align="center" class="embed-responsive embed-responsive-16by9">'+'<video controls controlsList="nodownload" class="embed-responsive-item"><source src="'+source+'" type="'+mimeType+'"></video>';
    }

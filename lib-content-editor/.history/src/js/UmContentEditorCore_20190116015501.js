...
UmContentEditorCore.prototype.saveEditorState = () =>{
    ...
    const activeElementPosition =  isInsideExtraWidget ? (isBelowQuestion ? 1:2):(isInsideQuestion ? 3:0);
    ...
    localStorage.setItem(editorContentStateKey,editorStateTracker[previousEditorStateIndex]);
};

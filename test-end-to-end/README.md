...
1.1 Admin can add H5P, video, EPUB and Experience API zip files from the device and by using a link. 
    ...
    [001_001_admin_can_add_content](test-end-to-end/test-descriptions/001_001_admin_can_add_content_test_description.md)
1.2 If admin uploads an invalid file where the file extension / mime type indicate that it should be 
    ...
    invalid.
    [001_002_admin_add_invalid_content_gets_error_message](test-end-to-end/test-descriptions/test-descriptions/001_002_admin_add_invalid_content_gets_error_message.md)

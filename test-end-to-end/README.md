...
7.2a [When registration is enabled: Users over 13 can register directly using a passkey on learning space](test-descriptions/007_002a_user_registration_above_age_13_test_description.md)

...
// Verify H5P content
  ...
  it('Student1 user makes attempts on H5p', () => {
    ...
    cy.ustadGetH5pBody().find(".h5p-true-false-answer", "Yes").first().click({force: 'true'});
    cy.ustadGetH5pBody().find(".h5p-question-check-answer.h5p-joubelui-button", "Check").should("exist");
  });

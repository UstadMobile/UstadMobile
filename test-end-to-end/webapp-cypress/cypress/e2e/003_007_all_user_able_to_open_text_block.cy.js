describe('Ustad mobile course tests', () => {
 ...
 it('003_007_all_user_able_to_open_text_block', () => {
   // cy.visit('http://localhost:8087/')
  ...
  // Add module block
    ...
    cy.wait(2000) // wait for 2 seconds
    cy.get('svg[data-testid="KeyboardArrowUpIcon"]').last().click()
    cy.wait(2000) // wait for 2 seconds
    cy.get('svg[data-testid="KeyboardArrowDownIcon"]').first().click()
    })

...
38. Click on "Courses" tab.
39. Click on the course name.
40. Click on "Edit" button.
41. Click on "Add block" button
42. Click on "Assignment".
43. Enter the assignment title in the "Title" field.
44. Enter the assignment description in the "Description" field.
45. Click on "Group Submission" switch
46. Click on "Groups" field.
47. Click on "Add new groups".
48. Enter a group title in "Title field"
49. Enter 2 in "Number of groups" field.
50. Assign first 3 students to Group 1.
51. Assign last 3 students to Group 2.
52. Click on "Save" button to save group details.
53. Set the submission policy to "Must submit all at once".
54. Click on the "Done" button.
55. Click on the "Save" button.
56. Clear the app storage
57. Login to the app using the student username and password in group 1.
58. Click on "Courses" tab.
59. Click on the course name.
60. Click on the assignment added by teacher.
61. Enter the assignment text in the provided text field.
62. Click on the "Submit" button.
63. Verify the submit status changed to "Submitted".
64. Clear the app storage
65. Login to the app using the another student username and password in same group 1.
66. Click on "Courses" tab.
67. Click on the course name.
68. Click on the assignment added by teacher.
69. Verify the "Text" ,"Add file" and "Submit" buttons are not visible to user since it is single submission.

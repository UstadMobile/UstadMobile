...
30. Login to the app using the teacher username and password.
31. Click on "Courses"
32. Click on Course name. 
33. Click on the "Edit" button. 
34. Click on the "Add block" button. 
35. Click on the "Discussion board" button. 
36. Enter "Title" for the discussion board.
37. Click on "Done" to save the discussion board. 
38. Click on "Save" to save the course changes. 
39. Verify the "Discussion board" is visible inside the course. 
40. Click on the discussion board name. 
41. Verify the "+ Post" button is visible inside the discussion board. 
42. Click "Back" button. 
43. Click on "Edit" button. 
44. Click on discussion board. 
45. Click on the description.
46. Enter a description.
47. Click on "Done" to save the description.
48. Click on "Done" to save the discussion board.
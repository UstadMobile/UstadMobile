...
46. Enter today's date and set the time to 1 hour minus the current time in the "End of grace period" field.
...
56. Verify that the "Submit" button is not visible.
...
35. Click on the "Save" button and save the person details. 
...
44. Login to the app using the teacher username and password.
45. Verify the teacher able to see the course 
46. Clear the app storage. 
47. Login to the app using the student username and password. 
48. Verify the student able to see the course